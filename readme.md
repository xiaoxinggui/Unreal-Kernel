## :warning: **THIS PROJECT IS UNMAINTAINED, AND PRIVATE STUFF IS GOING ON IN THE BACKGROUND. THIS IS JUST THE BACKUP FOR MY OLD CRAPPY "KERNEL". I MIGHT NEVER PUBLISH THE NEW STUFF, OR I MIGHT DO IT. BE AWARE THAT THIS CODE IS OLD AND NOOBISH, AND DON'T TAKE IT AS AN EXAMPLE OF HOW TO CODE.** :warning:
