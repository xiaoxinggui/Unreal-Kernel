debug_command:
    ; I won't comment that ok?
    ; it is so hardcoded and massive that its
    ; super easy to understand.

    ; If you want to commit the idioty of commenting
    ; this, just create a pull request.
